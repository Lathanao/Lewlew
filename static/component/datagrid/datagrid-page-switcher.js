...
export class DatagridPageSwitcher extends LewElement {
  ...
  get_template() {
    return `
  <div class="w-full flex items-start items-center justify-end">
    <div class="flex items-center lg:border-r border-gray-300">
      <div class="w-full flex items-center items-center">

        <p id="page-switcher-text" class="text-base text-gray-600">${this.__defaulttext}</p>
        
        <a type="minus" class="text-gray-600 border-transparent border bg-gray-100 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray mx-4 p-2">
        ...
        <a type="plus" class="text-gray-600 border-transparent border bg-gray-100 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray p-2">
    ...
    <div class="flex items-center border-gray-300 pl-6">
      <div class="relative w-20 z-10">
        <div class="pointer-events-none text-gray-600 absolute inset-0 m-auto mr-2 xl:mr-4 z-0 w-5 h-5">
