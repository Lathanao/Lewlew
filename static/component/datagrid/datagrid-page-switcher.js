  ...
  <div class="w-full flex items-start items-center justify-end">
    <div class="flex items-center lg:border-r border-gray-300">
      <div class="w-full flex items-center items-center">
        ...
        <a type="minus" class="text-gray-600 dark:text-gray-400 border-transparent border bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray mx-4 p-2">
        ...
        <a type="plus" class="text-gray-600 dark:text-gray-400 border-transparent border bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 hover:bg-gray-200 cursor-pointer rounded focus:outline-none focus:border-gray-800 focus:shadow-outline-gray p-2">
