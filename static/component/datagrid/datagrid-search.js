export class DatagridSearch extends HTMLElement {
  constructor() {
    super()
  }
    ...
    this.innerHTML = `
      <div class="container relative left-0 z-50 flex w-3/4 h-auto h-full">
        <div class="relative flex items-center w-full lg:w-64 h-full group">
          ...
          <input type="text" class="block w-full py-1.5 pl-10 pr-4 leading-normal rounded-2xl focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 ring-opacity-90 bg-gray-100 text-gray-400" placeholder="Search">
...
customElements.define('wc-datagrid-search', DatagridSearch)
