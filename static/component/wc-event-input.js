...
export class WCEventInput extends LewElement {
  ...
  update(state, props, storage, query) {
    this.innerHTML =
      '<input value="Updated!" id="event-input" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"/>'
  }
}
